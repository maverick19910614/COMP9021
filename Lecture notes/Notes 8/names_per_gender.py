...
Splits the data on the relative frequency of given names
...
"yobxxxx.txt with xxxx (the year of birth) ranging from 1880 to 2017.
...
if names_per_gender_dirname.exists():
    print(f'A directory named {names_per_gender_dirname} already exists.\n'
