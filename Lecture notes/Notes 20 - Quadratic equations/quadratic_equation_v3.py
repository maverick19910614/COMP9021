...
'''
Represents a quadratic equation as a class with a, b, c, root_1 and root_2 as data.
...
the update() function, a, b and c have to be explictly named.
...
QuadraticEquation = type('QuadraticEquation', (), {'__init__' : initialise,
                                                   'display': display,
