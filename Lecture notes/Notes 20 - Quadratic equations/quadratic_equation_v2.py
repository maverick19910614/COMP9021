...
'''
A quadratic equation is represented as a dictionary whose keys
are 'a', 'b', 'c', 'root_1' and 'root_2'.
The value of 'a' should be different to 0.

A dictionary QuadraticEquation packages the following functions:
* initialise(), to create an equation;
  by default, the value of 'a' is set to 1
  and the values of 'b' and 'c' are set to 0.
...
is created or by a call to update(), a, b and c have to be explicitly named.
...
def display(equation):
    ...
    x^2 = 0
    >>> QuadraticEquation['display'](QuadraticEquation['initialise'](c = -5, a = 2))
    2x^2 - 5 = 0
    >>> QuadraticEquation['display'](QuadraticEquation['initialise'](b = 1, a = -1, c = -1))
    -x^2 + x - 1 = 0
    '''
